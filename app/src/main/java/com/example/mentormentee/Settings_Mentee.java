...
public class Settings_Mentee extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_mentee);
        ...
        // Find views by ID
        contactUsTextView = findViewById(R.id.contactUsTextViewmen);
        aboutUsTextView = findViewById(R.id.AboutUsTextViewmen);
        termsandcondition = findViewById(R.id.terms_and_condition);
        logOutButton = findViewById(R.id.logOutButtonmen);
    ...
    private void openContactUs() {
        ...
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "siddheshgadade3@gmaila.com", null));
    ...
    private void openTermsAndConditions() {
        Intent intent = new Intent(Settings_Mentee.this, Terms_And_Condition.class);
    ...
    private void logOut() {
        ...
        Toast.makeText(Settings_Mentee.this, "LogOut Successfully", Toast.LENGTH_SHORT).show();

        Intent i = new Intent(Settings_Mentee.this, MainActivity.class);
        startActivity(i);
        finish();
